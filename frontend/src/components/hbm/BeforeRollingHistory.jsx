...
const BeforeRollingHistory = () => {
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      const res = await hbmAPI.getBeforeRollingLogs(params);
      setLogs(res.data);
    } catch {
      toast.error('Failed to load Before Rolling logs');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Before Rolling History</h1>
            <p className="text-sm text-gray-500">{logs.length} records</p>
          </div>
          <Link to="/hbm/before-rolling/new"
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-16 text-center">
            <p className="text-gray-400 text-lg">No Before Rolling logs found</p>
            <Link to="/hbm/before-rolling/new" className="mt-4 inline-block text-blue-700 font-semibold hover:underline">
...
export default BeforeRollingHistory;
