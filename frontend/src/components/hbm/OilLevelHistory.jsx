...
const OilLevelHistory = () => {
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      const res = await hbmAPI.getOilLevelLogs(params);
      setLogs(res.data);
    } catch {
      toast.error('Failed to load Oil Level logs');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Daily Oil Level History</h1>
              <p className="text-sm text-gray-500">{logs.length} records</p>
            </div>
          </div>
          <Link to="/hbm/oil-level/new"
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-16 text-center">
            <p className="text-gray-400 text-lg">No Oil Level logs found</p>
            <Link to="/hbm/oil-level/new" className="mt-4 inline-block text-blue-600 font-semibold hover:underline">
              Submit first report
            </Link>
          </div>
        ) : (
...
export default OilLevelHistory;
