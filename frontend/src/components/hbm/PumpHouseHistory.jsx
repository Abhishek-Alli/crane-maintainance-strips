...
const PumpHouseHistory = () => {
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      const res = await hbmAPI.getPumpHouseLogs(params);
      setLogs(res.data);
    } catch {
      toast.error('Failed to load Pumphouse logs');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await hbmAPI.deleteLog('pumphouse', id);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Pumphouse History</h1>
              <p className="text-sm text-gray-500">{logs.length} records</p>
            </div>
          </div>
          <Link to="/hbm/pumphouse/new"
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-16 text-center">
            <p className="text-gray-400 text-lg">No Pumphouse logs found</p>
            <Link to="/hbm/pumphouse/new" className="mt-4 inline-block text-blue-600 font-semibold hover:underline">
...
export default PumpHouseHistory;
